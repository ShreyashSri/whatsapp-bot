...
_CAPABILITY_NAMES = (
    ...
    "reminders.status", "reminders.config", "reminders.run", "reminders.history", "reminders.send",
...
TOOL_SPECS.update({
    ...
    "collections.tag": ToolSpec("collections.tag", mutating=True, executor="direct"),
    ...
    "reminders.send": ToolSpec("reminders.send", mutating=True, executor="direct"),
...
_DESCRIPTIONS = {
    ...
    "collections.tag": "tag all members of an existing subgroup",
