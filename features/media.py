...
COMMAND_HELP: dict[str, str] = {
    ...
    "card": (
        ...
        "For `talk`, the 3rd field is the talk topic/title and the 4th field is required "
        "as the event name. The template writes \"THANK YOU !!\", \"for presenting us at\", "
        "and \"and giving an insightful talk on\" automatically. Optional logo URLs render "
        "one logo centered or two logos side by side.\n\n"
        "*Types:*\n"
